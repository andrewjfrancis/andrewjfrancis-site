...
description: >
  When measurement structures visibility, it defines what can be judged, making judgment more reliable where metrics exist while making unmeasured work harder to evaluate consistently.
---
